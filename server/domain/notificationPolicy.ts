...
const safeCopies: Record<string, { title: string; body: string }> = {
  ...
  verification_submission_received: { title: "Verification submission received", body: "Your private identity document was received for manual review. Open Bantabato to review its current status." },
  verification_pending_review: { title: "Verification review is in progress", body: "Your private identity document is now in manual review. Open Bantabato to review the current status." },
  verification_changes_required: { title: "Verification needs attention", body: "A current supported document is needed before verification can continue. Open Bantabato to review the next step." },
  verification_completed: { title: "Verification review completed", body: "Your identity-document review is complete. Open Bantabato to review your current status." },
  verification_additional_review: { title: "Verification review continues", body: "Your identity-document review needs additional manual attention. Open Bantabato to review the current status." },
