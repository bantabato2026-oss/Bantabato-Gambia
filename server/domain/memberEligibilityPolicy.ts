...
export const ACTIVATION_JOURNEY_STATE_VALUES = ["NEW", "PROFILE_INCOMPLETE", "PHOTOS_INCOMPLETE", "PENDING_REVIEW", "PROFILE_READY", "DISCOVERY_READY", "PAUSED", "SUSPENDED"] as const;
export type ActivationJourneyState = (typeof ACTIVATION_JOURNEY_STATE_VALUES)[number];
